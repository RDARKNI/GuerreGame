...
//   curr_actions.clear();
//   if (!curr_source || curr_source.get_player_index() != curr_player_data.y) {
//     return;
//   }
...
//     bool possible{action.get_fatigue_condition(curr_source)};
...
//     }
//     curr_actions.emplace_back(to_index(action_id), possible);
//   }
// }
//
