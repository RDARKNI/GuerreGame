...
Game::Game(UserInput settings)
    : board{settings.src},
      actions{{std::make_unique<Move>(*this, board),
               std::make_unique<CreateUnit>(*this, board),
               std::make_unique<EndTurn>(*this, board),
               std::make_unique<Move>(*this, board),
               std::make_unique<Attack>(*this, board),
               std::make_unique<BuildUnit>(*this, board),
               std::make_unique<Harvest>(*this, board),
               std::make_unique<ToCastle>(*this, board),
               std::make_unique<Idle>(*this, board),
               std::make_unique<Convert>(*this, board),
               std::make_unique<ToMonk>(*this, board),
               std::make_unique<Cut>(*this, board),
               std::make_unique<Explode>(*this, board),
               std::make_unique<BuildTower>(*this, board),
               std::make_unique<ResearchUpgrade>(*this, board),
               std::make_unique<BuildBombardier>(*this, board)}},
