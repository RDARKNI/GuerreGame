...
//       {create_seigneur, gold >=
//       pieces_data[index(PieceType::Seigneur)].cout}, {create_guerrier, gold
//       >= pieces_data[index(PieceType::Guerrier)].cout}, {create_archer, gold
//       >= pieces_data[index(PieceType::Archer)].cout}};
// }
//
//// Pion& actor{board[src]};
//// Pion& target{board[dst]};
...
//   return {{OptionID::create_arbre, 1}, {OptionID::create_mine, 1}};
// }
